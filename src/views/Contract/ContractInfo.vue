            ...
            <div class="row mt-3 mb-3 title2 shortTitle">
              ...
              <div v-if="this.standard === 1">
                <el-button
                  ...
                  @click="getNep17Token(this.contract_id)"
                >
                  Token</el-button
                >
              </div>
              <div v-else-if="this.standard === 2">
                <el-button
                  ...
                  size="small"
                  style="height: 22px; margin-left: 10px"
                  @click="getNftToken(this.contract_id)"
                >
                  Token</el-button
                >
              </div>
            ...
            <card shadow class="card-style list">
              <div class="row mb-1">
                ...
                <div class="col-md-9 context-black">
                  ...
                  <el-tag
                    v-if="this.contract_info['updatecounter'] === -1"
                    type="danger"
                    size="small"
                  >
                    Destroyed
                  ...
                  <el-tag
                    v-else-if="this.nef['compiler'] === 'neo-core-v3.0'"
                    type="success"
                    size="small"
                  >
                    Native
                  ...
                  <el-tag
                    v-if="
                      this.whiteList.indexOf(this.contract_info['hash']) !== -1
                    "
                    type="success"
                    size="small"
                  >
                  ...
                  <i
                    v-else-if="
                      this.contract_info['updatecounter'] !== -1 &&
                      this.nef['compiler'] !== 'neo-core-v3.0' &&
                      this.isVerified
                    "
                    class="el-icon-circle-check"
                    style="color: #2dce89; font-weight: bold"
                  >
                    Verified
                  </i>
                  <i
              ...
              <div class="row info mt-3 mb-1">
                ...
                <div class="col-md-9 context-black" id="contract">
                  ...
                  <i
                    ...
                    @click="
                      copyItem('contract', 'contractButton', 'contractSpan')
                    "
                  ></i>
              ...
              <div class="row info mt-3 mb-1">
                <div class="col-md-3 lable-title">
                  ...
                  <el-button
                    ...
                    :plain="true"
                    size="small"
                    style="height: 19px; margin-left: 6px"
                ...
                <div class="col-md-9 context-black">
                  ...
                  <div v-else>
                    <router-link
                      ...
                      :to="
                        '/accountprofile/' +
                        addressToScriptHash(contract_info['sender'])
                      "
                      >{{
                        button.state
                          ? this.contract_info["sender"]
              ...
              <div class="row info mt-md-3 mb-1">
                <div class="col-md-3 lable-title">
                  {{ $t("contract.update") }}
                  <el-tooltip
                    :content="this.updateCountToolTip"
                    placement="top"
                  >
            ...
            >
              ...
              >
                <card
                  ...
                  class="text-center"
                  v-if="
                    this.isVerified && this.nef['compiler'] === 'neo-core-v3.0'
                  "
                >
                  This is a native contract, and the source code is registered
                  on the blockchain.
                </card>
                <div v-else-if="this.isVerified" class="text-center">
                  <source-code
                    :contractHash="contract_id"
                ...
                <card shadow v-else class="text-center">
                  Sorry, we were unable to locate a matching SourceCode for this
                  contract. If you are the contract owner, please
                  <router-link
                    class="name mb-0"
                    id="preHash"
                    style="cursor: pointer"
                    :to="'/VerifyContract/' + contract_id"
                  >
...
export default {
  ...
  data() {
    return {
      ...
      updatecounter: 0,
      whiteList: [
        "0x5ba6c543c5a86a85e9ab3f028a4ad849b924fab9",
        "0x385501cb0288b2953db767b0dc971478539456cb",
        "0xf8465c7a0700c8ee0bfdb932c7586b66938f90d2",
        ...
        "0xc777a8032c1d9d7b885c7357d4c93e7a39f93942",
        "0xedcbe55b04bcc7dad69cfe243bf3d26dc106a1d4",
        "0x3244fcadcccff190c329f7b3083e4da2af60fbce",
        "0x4d5a85b0c83777df72cfb665a933970e4e20c0ec",
        "0x59aa80468a120fe79aa5601de07746275c9ed76a",
        "0x6bcbf09a7193c968d608178a45785967f0721c42",
        "0x1404929a660620869c9cb46ff228ee9d7147959d",
        "0x171d791c0301c332cfe95c6371ee32965e34b606",
        "0x1b3f740240af479f07e44ee3ee78df4c6cb4b1fb",
        "0x45d182227b5d753c7f358594b631838b92caf409",
      ],
    };
  },
  created() {
  ...
  methods: {
    ...
    testAddress(addr) {
      axios({
        ...
        if (res["data"]["error"] == null) this.isAddress = true;
      });
    },
    testToken(contract) {
      axios({
